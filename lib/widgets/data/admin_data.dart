...
List<Admin> admins = [
  ...
  Admin(
    ...
    imageUrl2: 'images/spot/auditorium.webp',
    description:
        'Upon entering the Administration Building, You will see the office of the Registrar on the second office to the right part.',
    color: Color.fromARGB(255, 255, 99, 17),
  ),
  Admin(
    ...
    imageUrl: 'images/spot/library.webp',
    imageUrl2: 'images/spot/pso.webp',
    description:
        'Upon entering the Administration Building, You will see the office of the Registrar on the second office to the right part.',
    color: Color.fromARGB(255, 255, 99, 17),
  ),
  Admin(
    ...
    imageUrl: 'images/spot/library.webp',
    imageUrl2: 'images/spot/sts.webp',
    description:
        'Upon entering the Administration Building, You will see the office of the Registrar on the second office to the right part.',
    color: Color.fromARGB(255, 255, 99, 17),
  ),
  ...
  Admin(
    id: 39,
    name: 'Bids & Awards Committee Chair (BAC)',
  ...
  Admin(
    id: 40,
    name: 'Environmental Management Office (EMO)',
  ...
  Admin(
    id: 41,
    name: 'Food, Health, Safety & Housing Services',
  ...
  Admin(
    id: 44,
    name: 'Institutional Student Programs (ISP)',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 45,
    name: 'International Students Services (ISS)',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 46,
    name: 'Medical and Dental Services (MDS)',
    imageUrl: 'images/cmed/cmedbuilding.webp',
    imageUrl2: 'images/cmed/cmedbuilding.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 48,
    name: 'Physical Plant Maintenance (PPM)',
    imageUrl: 'images/spot/training.webp',
    imageUrl2: 'images/spot/training.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 49,
    name: 'Persons with Disabilities and Special Needs Services',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 50,
    name: 'Quality Assurance Office (QAO)',
  ...
  Admin(
    id: 51,
    name: 'Student Development Programs (SDP)',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 52,
    name: 'Scholarships & Financial Assistance (SFA)',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 53,
    name: 'Social Community Involvement & Multi-Faith Services',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description: '',
    color: Color.fromARGB(255, 255, 99, 17),
  ...
  Admin(
    id: 54,
    name: 'Production & Auxillary Services(PAS)',
    imageUrl: 'images/spot/library.webp',
  ...
  Admin(
    id: 56,
    name: 'Utility Services Office (USO)',
    imageUrl: 'images/spot/library.webp',
    imageUrl2: 'images/spot/pso.webp',
    description:
        'Upon Entering the University, you can see the Ilocano studies in the old C-Tech/Ite.',
  ...
  Admin(
    id: 57,
    name: 'Campus Security Services Office (CSSO)',
  ...
  Admin(
    id: 58,
    name: 'Guidance & Counselling Services',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description:
        'Upon Entering the University, you can see the Ilocano studies in the old C-Tech/Ite.',
  ...
  Admin(
    id: 59,
    name: 'Information & Orientation Services',
    imageUrl: 'images/spot/sc.webp',
    imageUrl2: 'images/spot/sc.webp',
    description:
        'Upon Entering the University, you can see the Ilocano studies in the old C-Tech/Ite.',
